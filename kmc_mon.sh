...
interfaceUrl='http://u2.kugou.net:11512/reportByGet'
...
function valueCheck(result, projectIdStr, earlyWarningStr, warningStr, earlyWarningMsgStr, warningMsgStr){
    ...
    for(i in result){
        ...
        curlCommand=\"curl '${interfaceUrl}?itemId=7026&ip=10.1.16.124&subId=requesttime&value=\" result[i] \"&itemLevel=0&itemPasswd='\";
        print curlCommand;
#        system(curlCommand);
    }
}
